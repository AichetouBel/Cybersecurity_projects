...
```
cd existing_repo
git remote add origin https://gitlab.com/rimsmarts/artificial-intelligence/cybersecurity2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rimsmarts/artificial-intelligence/cybersecurity2/-/settings/integrations)
